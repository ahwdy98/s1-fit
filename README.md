...
演示公式模块来自本地正式实现。已用 AAPL、GOOG、MP、KLAC、ORCL、RKLB、ONDS、KO、FSLY、FLNC、NVTS、AMBA、APP、SPCX、XBI、GLW、CRCL 和 AVGO 对比最近一年结果，B/S/IB/E 与连续数字均无差异。

部分公式允许最多下一根 K 线参与确认，所以回放到历史截止日期时，最后一根附近的信号可能与事后完整数据不同。这与正式实现的信号撤回行为一致。
